...
@NoArgsConstructor
@Getter
public class MyRecruitingBoardPageResDTO {
    ...
    private List<MyRecruitingBoardResponseDTO> contents;
    ...
    @Builder
    public MyRecruitingBoardPageResDTO(Page<MyRecruitingBoardResponseDTO> res){
    ...
    public static MyRecruitingBoardPageResDTO toDTO(Page<MyRecruitingBoardResponseDTO> page){
        return MyRecruitingBoardPageResDTO.builder()
                .res(page).build();
    }
}
