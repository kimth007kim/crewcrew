...
@NoArgsConstructor
@Getter
public class ApParticipatedPageResDTO {
    ...
    private List<ApplicationParticipatedDetailResponseDTO> contents;
    ...
    @Builder
    public ApParticipatedPageResDTO(Page<ApplicationParticipatedDetailResponseDTO> res){
    ...
    public static ApParticipatedPageResDTO toDTO(Page<ApplicationParticipatedDetailResponseDTO> page){
        return ApParticipatedPageResDTO.builder()
                .res(page).build();
    }
}
