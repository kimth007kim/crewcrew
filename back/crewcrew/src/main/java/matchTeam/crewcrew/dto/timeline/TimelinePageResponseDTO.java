...
@NoArgsConstructor
@Getter
public class TimelinePageResponseDTO {
    @ApiModelProperty(value = "조회 결과 존재 여부", dataType = "boolean", example = "true")
    private Boolean hasContent;

    @ApiModelProperty(value = "조회 결과", dataType = "List<TimelinePageDetailResponseDTO>")
    private List<TimelinePageDetailResponseDTO> contents;
    ...
    @Builder
    public TimelinePageResponseDTO(Page<TimelinePageDetailResponseDTO> res){
    ...
    public static TimelinePageResponseDTO toDTO(Page<TimelinePageDetailResponseDTO> page){
        return TimelinePageResponseDTO.builder()
                .res(page).build();
    }
}
