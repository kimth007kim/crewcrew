...
@NoArgsConstructor
@Getter
public class ApplicationDetailsPageResponseDTO {
    ...
    private List<ApplicationDetailResponseDTO> contents;
    ...
    @Builder
    public ApplicationDetailsPageResponseDTO(Page<ApplicationDetailResponseDTO> res){
    ...
    public static ApplicationDetailsPageResponseDTO toDTO(Page<ApplicationDetailResponseDTO> page){
        return ApplicationDetailsPageResponseDTO.builder()
                .res(page).build();
    }
}
