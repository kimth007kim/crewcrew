...
function PagenationProfile({ data, currentPage, postsPerPage, totalPage }) {
  ...
  const handleClickPrev = useCallback(() => {
    ...
    navigate(`/profile/${uid}?page=${(page - 1) * postsPerPage + 1}`);
  ...
  const handleClickNextLast = useCallback(() => {
    ...
    navigate(`/profile/${uid}?page=${totalPage}`);
  }, [totalPage, postsPerPage, btnDeactive, postId]);
...
export default PagenationProfile;
