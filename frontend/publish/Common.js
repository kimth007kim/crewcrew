...
window.addEventListener("DOMContentLoaded", function(){
    ...
    function scrollButton(){
        window.scrollY <= 100?buttonTop?.classList.add("Disable"):buttonTop?.classList.remove("Disable");
        window.scrollY >= body.offsetHeight - screen.availHeight?buttonBottom?.classList.add("Disable"):buttonBottom?.classList.remove("Disable");
    }
    scrollButton();
...
export const ProgressTransition = () => { //입력 완료된 input의 수에 따라 Stepbar 넓이 조절
